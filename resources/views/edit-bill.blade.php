            ...
            <div class="col-md-8">
                <div class="card shadow bg-white rounded">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update-bill/' . $editBillsID->approval_note_id) }}" class="mt-4 p-5" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col mb-3">
                            ...
                            <div class="mb-3">
                                <label for="file" class="form-label">Upload File (pdf, doc, docx, xls, xlsx) <span style="color: red">*</span></label>
                                <input type="file" class="form-control" name="file" id="file" accept=".pdf, .doc, .docx, .xls, .xlsx" required>
                            </div>
                            ...
                            <button type="submit" value="submit" class="btn btn-primary mt-3" style="background-color: #1a7c46; color: white">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
